...
import { localSeoPageContent, siteAssets } from "@/data/site-content";
...
export function LocalSeoPage({ page }: LocalSeoPageProps) {
  const content = localSeoPageContent;
      ...
      <article>
        <section className="relative isolate overflow-hidden border-b border-white/10 py-16 sm:py-20 lg:py-24">
          <Image
            ...
            alt={content.heroImageAlt(page.discipline)}
            fill
            priority
          ...
          <Container>
            <nav
              ...
              className="mb-8 text-sm font-semibold text-neutral-400"
            >
          ...
          <Container>
            <div className="grid gap-10 lg:grid-cols-[0.85fr_1fr] lg:items-start">
              <div>
                ...
                >
                  {content.overviewTitle(page.discipline)}
                </h2>
                <p className="mt-5 leading-7 text-neutral-300">{content.overviewDescription}</p>
              </div>
        ...
        <section aria-labelledby="training-focus-title" className="bg-brand-ink py-16 sm:py-20">
          <Container>
            <div className="max-w-3xl">
              <p className="text-sm font-black uppercase text-brand-yellow">
                {content.trainingFocusEyebrow}
              </p>
              <h2
                id="training-focus-title"
                className="mt-3 text-3xl font-black text-brand-white sm:text-4xl"
              >
                {content.trainingFocusTitle}
              </h2>
              <p className="mt-5 leading-7 text-neutral-300">{content.trainingFocusDescription}</p>
            </div>
        ...
        <section id="faq" aria-labelledby="faq-title" className="bg-brand-black py-16 sm:py-20">
          <Container>
            <div className="max-w-3xl">
              <p className="text-sm font-black uppercase text-brand-yellow">{content.faqEyebrow}</p>
              <h2 id="faq-title" className="mt-3 text-3xl font-black text-brand-white sm:text-4xl">
                {content.faqTitle(page.discipline)}
              </h2>
            </div>
          ...
          <Container>
            <div className="combat-card combat-card--accent p-6 sm:p-8">
              ...
              <h2
                ...
                className="mt-3 text-3xl font-black text-brand-white sm:text-4xl"
              >
                {content.contactTitle(page.discipline)}
              </h2>
              <p className="mt-5 max-w-3xl leading-7 text-neutral-300">
                {content.contactDescription(page.discipline)}
              </p>
